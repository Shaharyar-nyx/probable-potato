...
const PACKAGES_CONFIG = {
  header: {
    ...
    description: "Compare plans below, and get in touch for customized solutions.",
  },
  packages: {
    cyberscan: {
      price: "$4,500",
  ...
  features: [
    ...
    },
    {
      ...
      tooltip: "It confirms the information about you or your business that can be found online",
      cyberscan: true,
      cybershield: true,
      cyberswarm: true,
    },
    {
      name: "Dark Web Scan",
      tooltip: "Identify non-indexed internet risks to your organization or employees",
      cyberscan: true,
      cybershield: true,
      cyberswarm: true,
    },
  ...
  return (
    <div className={styles.container} style={{ backgroundImage: `url(/images/bg-image.jpeg)` }}>
      <div className={styles.header}>
        <h2 className="text-h2__big mb-3 text-primary-800">Cyberbay Packages</h2>

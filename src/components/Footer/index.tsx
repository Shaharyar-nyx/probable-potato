        ...
        <div className="flex flex-col space-y-8">
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-16">
            ...
            <div className="flex flex-col lg:flex-row gap-16">
              <div className="flex-shrink-0">
                <Link href="/" className="block w-[140px]">
                  <Image src={Logo} alt="Cyberbay" width={140} height={24} />
                </Link>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-x-5 gap-y-12">
                {navigationData.map((section) => (
                  <div key={section.title}>
                    <h3 className="text-base font-primaryBold mb-6">
                      {section.title}
                    </h3>
            ...
            <div className="lg:w-[360px] flex-shrink-0">
              <h3 className="text-base font-primaryBold mb-4">Stay Connected</h3>
              ...
              <div className="flex flex-col gap-3">
                <input
                  ...
                  className="w-full px-1 py-2 bg-transparent border-b border-primary-500 text-[14px] text-white placeholder-[#EFF0F2B2] focus:outline-none"
                />
                <button className="w-full px-8 py-3 bg-primary-500 text-[14px] text-white font-medium rounded hover:bg-[#1E90FF]/90 transition-colors">
                  Subscribe
                </button>
              </div>
            </div>

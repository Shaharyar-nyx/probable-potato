...
const socialLinks: SocialLink[] = [
  {
    platform: "Facebook",
    href: "https://www.facebook.com/reimagine.cyberbay",
    icon: (
  ...
  {
    platform: "Instagram",
    href: "https://www.instagram.com/reimagine.cyberbay/",
    icon: (
      <svg fill="currentColor" height="24" viewBox="0 0 24 24" width="24">
  ...
  {
    platform: "LinkedIn",
    href: "https://www.linkedin.com/company/cyberbay-cyber-experience-community/",
    icon: (
      <svg fill="currentColor" height="24" viewBox="0 0 24 24" width="24">

...
export const EventUpcoming2025 = ({ title, subtitle, events }: any) => {
  return (
          ...
          <div className="overflow-hidden rounded-2xl bg-white p-8 shadow-lg">
            <div className="flex items-center justify-center gap-8">
              ...
              <div className="flex-grow">
                <h3 className="mb-4 text-[24px] font-bold text-[#02255B]">BugHunting Campaign 2025</h3>
                <p className="mb-6 text-[16px] font-normal text-[#02255B]">
                  Join Cyberbay, the Cyber Security and Technology Crime Bureau (CSTCB) of the Hong Kong Police Force,
                  and The Office of the Privacy Commissioner for Personal Data (PCPD) in the 2025 BugHunting Campaign—a
                  collaborative initiative to uncover vulnerabilities, fortify defenses, and earn the exclusive
                  BugHunting 2025 Badge.
                </p>
              </div>

...
export const solutionsContent = {
  ...
  solutions: [
    ...
    },
    {
      ...
      description: "Leverage the power of crowdsourcing with our pre-vetted ethical hacking community. On-demand resources provide cost-effective scalability and pre-vetted talent gives you peace of mind.",
    },
    {
      icon: Advisory,
  ...
  crowdsourcing: {
    label: "Why Crowdsourcing",
    title: "Scaling Cybersecurity with Crowdsourcing",
    description: "Cyberbay's services deliver comprehensive protection for organizations against dynamic cyberattacks. Our proactive strategy guarantees the security and resilience of your digital assets, safeguarding them against potential vulnerabilities.",
    benefits: [
      {
      ...
      },
      {
        ...
        description: "Leverage global cybersecurity experts to strengthen your digital asset protection and security posture."
      }
    ]
  }
};
